...
4. If the file is in a ZIP archive, save it to your Downloads folder or Desktop.

5. If you see an EXE file, save it in a folder you can find again.

## 🧰 How to Install

1. Open the ZIP file if the download came as an archive.

2. Extract the files to a folder on your PC.

3. If the download is an EXE, right-click it and choose Run as administrator if Windows asks for it.

4. Follow the on-screen prompts until setup ends.

5. Keep the app in a folder with full read and write access.

6. If Windows SmartScreen appears, choose the option that lets you continue only if you trust the source of the file you downloaded.

## 🖱️ How to Run the App

1. Open the folder where you extracted or installed the app.

2. Find the main app file.

3. Double-click it to launch the tool.

4. If the app opens in a small window, you can resize it using normal Windows controls.

5. Keep the game closed until you are ready to test the tool on it.

## 🎮 Basic Use

1. Start the game you want to inspect.

2. Open this tool as the same Windows user.

3. Pick the target process from the list of running apps.

4. Search for the value you want to change.

5. Narrow the result list by changing the value in the game and scanning again.

6. Select the right address from the result list.

7. Edit the value and test it in the game.
...
1. Open the game.
2. Note your current health value.
3. Open the tool.
4. Search for that number.
5. Take damage in the game.
6. Search again with the new number.
7. Keep filtering until only a few matches remain.
8. Change the value and test the result.

If you want to test currency changes:

1. Open the game.
2. Check your current money value.
3. Search for it in the tool.
4. Spend money in the game.
5. Search again with the new value.
6. Edit the final result.

## ⚙️ Settings You May Use
...
### I cannot find the game process
- Start the game first.
- Wait a few seconds for it to load.
- Refresh the process list.
- Try again after the main menu appears.

### The scan gives too many results
...
### The game closes after I edit a value
